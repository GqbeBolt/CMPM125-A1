...
public class VehicleController : MonoBehaviour
{
    ...
    private float desired_accelerationY;
    public float power;
    ...
    void Update()
    {
        GetComponent<Rigidbody>().AddRelativeForce(new Vector3(desired_accelerationX * power, 0, desired_accelerationY * power));
    ...
    void OnMove(InputValue action)
    {
        ...
        desired_accelerationY = -movement.x;
